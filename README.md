...
1. **Gestión de Movimiento (Controlador):** Captura de eventos del teclado (`KEYDOWN`) para actualizar vectores de dirección en los ejes X e Y.
...
4. **Dificultad Adaptativa:** El sistema ajusta los FPS (`fps.tick`) dinámicamente según el puntaje alcanzado (incremento de velocidad tras los primeros 3 puntos).
5. **Interfaz de Usuario (Vista)** donde renderizado en tiempo real de gráficos 2D y visualización del puntaje en pantalla.

## Requisitos e Instalación
1. Tener instalado **Python 3.12.0**.
